...
window.TRIUMPH_DATA = {
  ...
  /* ---------------------------------------------------------------------
     ...
     --------------------------------------------------------------------- */
  locations: [
    { name: "St. Hilary", area: "Chicago — North Side", address: "[ADDRESS TO BE SUPPLIED]" },
    { name: "St. Paul", area: "Chicago / North suburbs", address: "[ADDRESS TO BE SUPPLIED]" },
    { name: "St. Matthias", area: "Chicago — North Side", address: "[ADDRESS TO BE SUPPLIED]" }
  ],
  ...
  staff: [
    ...
    { name: "Coach Oli [LAST NAME]", role: "Co-Founder / Coach", photo: "", bio: "" },
